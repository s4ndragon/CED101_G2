...
try {
	...
	$sql = "select a.HOTEL_ID HOTEL_ID, a.HOTEL_NAME HOTEL_NAME, a.HOTEL_INFRO HOTEL_INFRO, a.HOTEL_STATUS HOTEL_STATUS, b.GARD_ID from HOTEL a join HOTEL_LIST b on a.HOTEL_ID=b.HOTEL_ID
            order by a.HOTEL_ID desc
    ";
