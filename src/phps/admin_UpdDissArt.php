...
try {
    ...
    //php叫物件內屬性的寫法
    $REP_NO = $decoded["REP_NO"];
    $AR_STATUS = $decoded["AR_STATUS"]; 
    ...
    $per_ord_data->bindValue(":REP_NO", $REP_NO);
    $per_ord_data->bindValue(":AR_STATUS", $AR_STATUS);
    ...
    $per_ord_data->bindValue(":ART_STATUS", $ART_STATUS);
